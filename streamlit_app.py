...
with st.sidebar:
    ...
    st.markdown(
        ...
        **Many-to-Many**  
        Multiple participants can send and receive media.
        """
    )
    ...
    pc.onicecandidate =
        function(event) {{
            ...
            if (
                ...
                console.warn(
                    "Cannot send ICE - WebSocket not open"
                );
